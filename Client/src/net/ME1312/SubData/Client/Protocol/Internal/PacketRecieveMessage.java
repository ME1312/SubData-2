...
public class PacketRecieveMessage implements PacketStreamIn {
    ...
    @Override
    public void receive(InputStream data) throws Throwable {
        ...
        HashMap<String, HashMap<String, MessageIn>> mIn = Util.reflect(DataClient.class.getDeclaredField("mIn"), null);
        ...
        message.receive();
        if (message instanceof MessageStreamIn) ((MessageStreamIn) message).receive(data);
        else data.close();
    }
